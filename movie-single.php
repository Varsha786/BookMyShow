                            ...
                            <li class="w3_megamenu-content">
								...
								<h5 class="movies-page">for movies page - <a href="movies.html">Click here</a> </h5>
                                    <div class="col-sm-4">
										...
										<ul class="mov_list">
						<li>99%</li>
						<li><a href="movie-single.php">Baahubali (Telugu) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li>100%</li>
						<li><a href="movie-single.php">Baahubali (Hindi) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li>98%</li>
						<li><a href="movie-single.php">Baahubali (English) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li>80%</li>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="movie-select-show.php">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="movie-select-show.php">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">INOX: Lorem Mall, Chicago</p>
				 <a class="show-time" href="movie-select-show.php">12:45 PM</a><a class="show-time" href="movie-select-show.php">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="movie-select-show.php">More Show Times</a>
			  </div>
			</div>
